...
let private pathIcon (data: string) (size: Size) (color: string) =
    let baseSize = 24.
...
let private svgIcon (name: string) (size: Size) (color: string) =
    Svg.create [ Svg.path $"Assets/{name}.svg" ]
...
let home =
    pathIcon "M10,20V14H14V20H19V12H22L12,3L2,12H5V20H10Z"
...
let openTo = svgIcon "flower-open-to"
...
let connected =
    pathIcon "M16,7V3H14V7H10V3H8V7H8C7,7 6,8 6,9V14.5L9.5,18V21H14.5V18L18,14.5V9C18,8 17,7 16,7Z"
