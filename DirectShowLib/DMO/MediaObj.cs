...
public sealed class DMOCategory
{
    ...
    public static readonly Guid AudioDecoder =
        new(0x57f2db8b, 0xe6bb, 0x4513, 0x9d, 0x43, 0xdc, 0xd2, 0xa6, 0x59, 0x31, 0x25);
    ...
    public static readonly Guid VideoDecoder =
        new(0x4a69b442, 0x28be, 0x4991, 0x96, 0x9c, 0xb5, 0x00, 0xad, 0xf5, 0xd8, 0xa8);
    ...
    public static readonly Guid AudioEffect =
        new(0xf3602b3f, 0x0592, 0x48df, 0xa4, 0xcd, 0x67, 0x47, 0x21, 0xe7, 0xeb, 0xeb);

    /// <summary> DMOCATEGORY_VIDEO_EFFECT </summary>
    public static readonly Guid VideoEffect =
        new(0xd990ee14, 0x776c, 0x4723, 0xbe, 0x46, 0x3d, 0xa2, 0xf5, 0x6f, 0x10, 0xb9);

    /// <summary> DMOCATEGORY_AUDIO_CAPTURE_EFFECT </summary>
    public static readonly Guid AudioCaptureEffect =
        new(0xf665aaba, 0x3e09, 0x4920, 0xaa, 0x5f, 0x21, 0x98, 0x11, 0x14, 0x8f, 0x09);
...
public sealed class DMOUtils
{
    ...
    [DllImport("msdmo.dll", ExactSpelling = true)]
    ...
    [DllImport("MSDmo.dll", CharSet = CharSet.Unicode, ExactSpelling = true)]
    [SuppressUnmanagedCodeSecurity]
    ...
    public static extern int DMOGetName(
        [In] [MarshalAs(UnmanagedType.LPStruct)]
        Guid clsidDMO,
        [Out] [MarshalAs(UnmanagedType.LPWStr, SizeConst = 80)]
