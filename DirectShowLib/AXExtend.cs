...
namespace DirectShowLib
{
    ...
    public struct AMCOPPCommand
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, ArraySubType = UnmanagedType.I1, SizeConst =
 4056)] public byte[] CommandData;
    }
