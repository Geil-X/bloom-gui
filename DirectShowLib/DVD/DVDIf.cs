...
public interface IDvdControl2
{
    ...
    int PlayPeriodInTitleAutoStop(
        [In] int ulTitle,
        [In] [MarshalAs(UnmanagedType.LPStruct)]
        DvdHMSFTimeCode pStartTime,
        [In] [MarshalAs(UnmanagedType.LPStruct)]
        DvdHMSFTimeCode pEndTime,
        [In] DvdCmdFlags dwFlags,
        [Out] out IDvdCmd ppCmd
    );
...
public interface IDvdInfo2
{
    ...
    int GetKaraokeAttributes(
        [In] int ulStream,
        [In] [Out] [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DKAMarshaler))]
        DvdKaraokeAttributes pAttributes
    );
    ...
    int GetPlayerParentalLevel(
        [Out] out int pulParentalLevel,
        [Out] [MarshalAs(UnmanagedType.LPArray, SizeConst = 2)]
        byte[] pbCountryCode
    );
