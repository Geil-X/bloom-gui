...
public sealed class SBEEvent
{
    ...
    public static readonly Guid RecControlStarted =
        new(0x8966a89e, 0xf83e, 0x4c0e, 0xbc, 0x3b, 0xbf, 0xa7, 0x64, 0x9e, 0x4, 0xcb);

    /// <summary> EVENTID_SBE2RecControlStopped </summary>
    public static readonly Guid RecControlStopped =
        new(0x454b1ec8, 0xc9b, 0x4caa, 0xb1, 0xa1, 0x1e, 0x7a, 0x26, 0x66, 0xf6, 0xc3);

    /// <summary> SBE2_STREAM_DESC_EVENT </summary>
    public static readonly Guid StreamDescEvent =
        new(0x2313a4ed, 0xbf2d, 0x454f, 0xad, 0x8a, 0xd9, 0x5b, 0xa7, 0xf9, 0x1f, 0xee);

    /// <summary> SBE2_V1_STREAMS_CREATION_EVENT </summary>
    public static readonly Guid V1StreamsCreationEvent =
        new(0xfcf09, 0x97f5, 0x46ac, 0x97, 0x69, 0x7a, 0x83, 0xb3, 0x53, 0x84, 0xfb);

    /// <summary> SBE2_V2_STREAMS_CREATION_EVENT </summary>
    public static readonly Guid V2StreamsCreationEvent =
        new(0xa72530a3, 0x344, 0x4cab, 0xa2, 0xd0, 0xfe, 0x93, 0x7d, 0xbd, 0xca, 0xb3);
}
...
public interface IEnumStreamBufferRecordingAttrib
{
    ...
    int Next(
        ...
        StreamBufferAttribute[] pStreamBufferAttribute,
...
public interface IStreamBufferMediaSeeking : IMediaSeeking
{
    ...
    new int ConvertTimeFormat(
        ...
        DsGuid pTargetFormat,
        [In] long Source,
        [In] [MarshalAs(UnmanagedType.LPStruct)]
        DsGuid pSourceFormat
    );
...
public interface ISBE2EnumStream
{
    ...
    int Next(
        int cRequest,
        [In] [Out] [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(SDMarshaler))]
        SBE2_StreamDesc[] pStreamDesc,
        IntPtr pcReceived
    );
...
internal class SDMarshaler : ICustomMarshaler
{
    ...
    public IntPtr MarshalManagedToNative(object managedObj)
    {
        ...
        var iSize = m_sd.Length * Marshal.SizeOf(typeof(SBE2_StreamDesc));

        ip = Marshal.AllocCoTaskMem(iSize);

#if DEBUG
        for (var x = 0; x < iSize / 8; x++) Marshal.WriteInt64(ip, x * 8, 0);
#endif
