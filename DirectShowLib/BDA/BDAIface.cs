...
#region Interfaces
    ...
    public interface IEnumPIDMap
    {
        ...
        int Next(
            [In] int cRequest,
            [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0, ArraySubType =
 UnmanagedType.Struct)] PIDMap[] pPIDMap,
...
public interface IBDA_Topology
{
    ...
    int GetNodeTypes(
        ...
        [Out] [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.I4, SizeParamIndex = 1)]
        int[] rgulNodeTypes
    );
    ...
    int GetNodeDescriptors(
        ...
        [Out] [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPStruct, SizeParamIndex = 1)]
    ...
    int GetNodeInterfaces(
        ...
        [Out] [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPStruct, SizeParamIndex = 2)]
